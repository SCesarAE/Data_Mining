...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 25 20:00:25 2021
...
Hacer una función que calcule el coeficiente de correlación de Pearson para
dos variables. Pasar como parámetro las listas de valores para cada variable-
...
def coef_pearson(values_1, values_2):
    ...
    return coef
        ...
        sumatoria((x_1 - x_md)(y_i - y_md)
r=-------------------------------------------------
  (raizcuadrada(sumatoria((x_1 - x_md)^2)raizcuadrada(sumatoria((y_i - y_md)^2)))
"""
